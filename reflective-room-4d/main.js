...
pbg.addColorStop(0,'#3a2810'); pbg.addColorStop(1,'#5a3e1a');
pctx.fillStyle=pbg; pctx.fillRect(0,0,512,640);
[['#c87820',0.55,256,240,110,140],['#e8a030',0.40,240,200,85,100],['#a04818',0.60,280,290,90,110],['#f0c060',0.30,270,180,65,80]].forEach(([col,alpha,x,y,rx,ry])=>{
  pctx.globalAlpha=alpha; pctx.fillStyle=col; pctx.beginPath(); pctx.ellipse(x,y,rx,ry,0,0,Math.PI*2); pctx.fill();
});
pctx.globalAlpha=0.45; pctx.fillStyle='#ffd080'; pctx.beginPath(); pctx.ellipse(265,195,55,70,-0.1,0,Math.PI*2); pctx.fill();
pctx.globalAlpha=1; pctx.strokeStyle='rgba(0,0,0,0.4)'; pctx.lineWidth=14; pctx.strokeRect(7,7,498,626);
